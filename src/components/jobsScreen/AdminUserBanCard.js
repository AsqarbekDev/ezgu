...
function AdminUserBanCard({
  ...
  return (
    <>
      ...
      {showUnbanUserModul && (
        <div className="fixed z-[98] max-w-2xl flex items-center -mt-11 justify-center top-0 bottom-0 left-0 right-0">
          <div className="rounded-xl bg-black text-white text-lg p-6 m-8 text-center">
            <p>Foydalanuvchini bandan chiqarishni xoxlaysizmi?</p>
            <div className="flex items-center justify-around mt-6">
              <button
                onClick={() => setShowUnbanUserModul(false)}
